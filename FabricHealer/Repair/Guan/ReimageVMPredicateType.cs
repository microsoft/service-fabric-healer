...
namespace FabricHealer.Repair.Guan
{
    public class ReimageVMPredicateType : PredicateType
    {
        ...
        private static ReimageVMPredicateType Instance;
        ...
        class Resolver : BooleanPredicateResolver
        {
            ...
            protected override bool Check()
            {
                ...
                // Repair Policy
                this.repairConfiguration.RepairPolicy.CurrentAction = RepairAction.ReimageVM;
                ...
                if (isRepairAlreadyInProgress)
                {
                    ...
                    RepairTaskHelper.TelemetryUtilities.EmitTelemetryEtwHealthEventAsync(
                        LogLevel.Info,
                        $"ReimageVMPredicateType::{FOHealthData.RepairId}",
                        message,
                        RepairTaskHelper.Token).GetAwaiter().GetResult();
        ...
        public static ReimageVMPredicateType Singleton(
                    string name,
                    ...
                    TelemetryData foHealthData)
        {
            ...
            return Instance ??= new ReimageVMPredicateType(name);
        }

        private ReimageVMPredicateType(
            string name)
            : base(name, true, 0, 2)
        {
