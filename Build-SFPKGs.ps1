...
try {
    ...
    Build-SFPkg "Microsoft.ServiceFabricApps.FabricHealer.Linux.SelfContained.1.3.0" "$scriptPath\bin\release\FabricHealer\linux-x64\self-contained\FabricHealerType"
    Build-SFPkg "Microsoft.ServiceFabricApps.FabricHealer.Linux.FrameworkDependent.1.3.0" "$scriptPath\bin\release\FabricHealer\linux-x64\framework-dependent\FabricHealerType"
