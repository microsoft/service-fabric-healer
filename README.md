...
```
FabricHealer requires that FabricObserver (3.1.6 and higher) and the RepairManager service are deployed in the cluster. 
For VM level repair, InfrastructureService service must be deployed.
```
